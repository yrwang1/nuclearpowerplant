...
The ridgeline plot allow us to easily compare distributions of the absorbed doses. We see that the distributions for all age groups are multimodal that have many peaks. The younger the higher doses were absorbed, and the absorb range is wider.
